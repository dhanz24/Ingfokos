...
<head>
    ...
    <title>IngfoKos | Cari kost-kostsan di bandung</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>Main_Front_User"><img src="<?php echo base_url()?>assets/images/ingfokos-trans.png" width="150px" align="center"></a>
            </div>
